...
[![Portfolio](https://img.shields.io/badge/Portfolio-2EA44F?style=flat&logo=github&logoColor=white)](https://github.com/dimayo/portfolio)
...
| Проект | Результат |
|---|---|
| [A/B-тест + кластеризация](https://github.com/dimayo/portfolio/tree/main/sporting_store) | Персональная скидка: +19% ARPU, четыре сегмента для следующих рассылок |
| [LTV / когорты / ROI](https://github.com/dimayo/portfolio/tree/main/fintech_ltv) | Когорты сент.–окт. 2016 с макс. LTV; топ-каналы — органика, прямой и контекст |
