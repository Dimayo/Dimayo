...
| Проект | Результат |
|---|---|
| [Продажи маркетплейса](https://github.com/dimayo/portfolio/tree/main/marketplace_sales) | Дашборд DataLens: продажи **5,62 млрд** ₽; план выполнен; электроника лидирует по выручке |
