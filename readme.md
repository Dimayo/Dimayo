...
| Проект | Результат |
|---|---|
| [Дашборды DataLens](https://github.com/dimayo/portfolio/tree/main/datalens_dashboards) | 3 дашборда: продажи **5,62 млрд** ₽; план выполнен; электроника лидирует по выручке |
